...
export function GameButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "h-10 lg:h-12 px-1 lg:px-6 border transition-all duration-300 flex items-center justify-center gap-1 lg:gap-3 text-[10px] lg:text-xs font-bold tracking-wider uppercase group w-full lg:w-auto",
