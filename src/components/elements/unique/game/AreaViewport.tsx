...
export function AreaViewport({
  ...
  return (
    <section className="flex-1 min-h-0 cozy-panel bg-palette-bg-mid/10 flex flex-col items-center p-1.5 sm:p-2 relative overflow-hidden group">
      ...
      <div className="w-full h-full flex flex-col items-center overflow-y-auto z-10 relative">
        <div className="w-full max-w-4xl text-center my-auto">
          <span className="text-palette-accent-mid/70 tracking-[0.22em] uppercase mb-0.5 block leading-tight">{area.regionalType}</span>
          <h2 className="font-display font-black text-palette-white mb-1 tracking-[0.14em] uppercase contrast-125 drop-shadow-md leading-tight lantern-glyph" data-text={area.title}>
            {area.title}
          </h2>
          <div className="w-8 sm:w-12 h-px bg-palette-border-light/60 mx-auto mb-1 sm:mb-1.5" />
          <p className="leading-relaxed text-palette-muted-light italic mb-1.5 sm:mb-2 max-w-xl mx-auto px-2">
            &quot;{area.description}&quot;
          </p>
