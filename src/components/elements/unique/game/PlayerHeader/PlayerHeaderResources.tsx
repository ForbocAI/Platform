  ...
  return (
    <div className="flex items-center gap-1 sm:gap-1.5 lg:gap-2" title="Spirit / Blood / Surge">
      <div className="flex items-center gap-1" title="Spirit">
        ...
        <span className="hidden sm:inline font-black text-palette-accent-mid tabular-nums leading-tight">{player.spirit ?? 0}</span>
      </div>
      <div className="flex items-center gap-1" title="Blood">
        ...
        <span className="hidden sm:inline font-black text-palette-accent-mid tabular-nums leading-tight">{player.blood ?? 0}</span>
      </div>
