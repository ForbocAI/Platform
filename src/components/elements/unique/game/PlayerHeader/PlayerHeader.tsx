...
export function PlayerHeader({ player }: { player: PlayerActor }) {
  return (
    <header
      className="shrink-0 cozy-panel bg-palette-bg-mid/40 flex flex-col lg:flex-row items-start lg:items-center justify-between p-1.5 sm:p-2 gap-1.5 sm:gap-2 overflow-x-auto min-w-0"
