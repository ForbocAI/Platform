              ...
              {merchant.wares.map((item) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="px-2 py-1 bg-palette-accent-cyan/20 border border-palette-accent-cyan/50 text-palette-accent-cyan text-xs uppercase hover:bg-palette-accent-cyan/30"
                  >
                    Buy
                  </button>
                </li>
