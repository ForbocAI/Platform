...
export function PlayerHeader({ player }: { player: Player }) {
  return (
    <header
      className="shrink-0 vengeance-border bg-palette-bg-mid/50 flex flex-col lg:flex-row items-start lg:items-center justify-between p-1.5 sm:p-2 gap-1.5 sm:gap-2"
